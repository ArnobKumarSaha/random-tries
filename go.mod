module github.com/Arnobkumarsaha/random-tries
...
require (
	...
	kmodules.xyz/resource-metrics v0.30.2-0.20240705061545-041dbab8db1d
	kubedb.dev/apimachinery v0.46.1-0.20240701130816-42019af5f26e
	kubestash.dev/apimachinery v0.10.0
